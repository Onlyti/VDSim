...
public:
    ...
    void save_aux(std::vector<double>& v) const override {
        ...
        v.push_back(ax_felt_);
        v.push_back(ay_felt_);
        v.push_back(roll_qs_);
        v.push_back(pitch_qs_);
        v.push_back(mz_front_sum_);
        v.push_back(centripetal_accel_substep_);
        v.push_back(vy_r_substep_);
    }
    void restore_aux(const std::vector<double>& v, std::size_t& p) override {
        ...
        ax_felt_ = snap::get(v, p);
        ay_felt_ = snap::get(v, p);
        roll_qs_ = snap::get(v, p);
        pitch_qs_ = snap::get(v, p);
        mz_front_sum_ = snap::get(v, p);
        centripetal_accel_substep_ = snap::get(v, p);
        vy_r_substep_ = snap::get(v, p);
    }
