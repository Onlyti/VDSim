...
> (L5, grade+bank → InclinedGround, no `.bin`). 272/272 ctest. **Still open:** M4 (GUI
> terrain Play, needs browser), M5b `CurvedGround` (arc/spline banked *oval*, the v0.4
> descope), M5c GUI stunt authoring, M6 (docs + tag).
