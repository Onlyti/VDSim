...
> **M0/M1 status (2026-06-09):** the hub-contact unification (M0) already shipped
...
> (synthetic in-memory grids, no `.bin` blobs). 269/269 ctest. Next: M2 (cliff /
> airborne), then M3 (scene) → M4 (GUI).
