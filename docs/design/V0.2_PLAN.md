...
Status: **v0.2.4 GUI + v0.3 catalog shipped (2026-06-06)**. WS3–WS4 + catalog
cutover complete. WS1 drivetrain inertia + LuGre tire **implemented** (opt-in /
defaults preserve legacy behaviour). Engine torque–RPM map still open.
