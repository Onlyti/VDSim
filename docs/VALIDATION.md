...
| Full suite: **PENDING canonical CI remeasurement** (`validation` preset — see the currency block below) | — |
...
commit:   PENDING
date:     2026-09-18
pending:  Q3 adds JSON and NMEA GGA parser tests through tests/unit/CMakeLists.txt; canonical CI must pass three times on one head.
