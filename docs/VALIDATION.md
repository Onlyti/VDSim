...
```text
tests:    PENDING
pending:  campaign_runner (Q10) adds one ctest target; the canonical count is
pending:  whatever the CI validation job measures on this tree. 504/504 was
pending:  measured at 60b19c7 and no longer describes it.
