...
**Last updated:** 2026-06-10 · **Tests:** 327/327 ctest green (`main`)
...
| Validation | ISO 7401/4138/3888 **re-baselined + CI-gated** (`IsoBaseline`), 327 ctest | Adams x-check rtol; commercial cross-val |
...
| [x] **327** automated ctests | Shipped | 2026-06-10 |
...
> parts catalog, real-time UDP/FMI, and ISO-standard validation (327 ctests).
