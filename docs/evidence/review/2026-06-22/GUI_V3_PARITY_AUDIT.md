# GUI v3 parity audit — 2026-06-22

Automated static audit (no browser). P0 gaps: **3**
...
| SH-05 | P0 | GAP | mkdocs [?] help links not wired |
| SH-06 | P1 | GAP | panel resize persist |
| CO-00 | P0 | GAP | template gallery |
