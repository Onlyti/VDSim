...
VEHICLE_FIELDS = [
    ...
    ("arb_stiffness_front", "Anti-roll bar front [N·m/rad]", "Suspension", "num", "L2,L3"),
    ("arb_stiffness_rear", "Anti-roll bar rear [N·m/rad]", "Suspension", "num", "L2,L3"),
    ...
    ("anti_dive_front", "Anti-dive front [0–1]", "Suspension", "num", "L3"),
    ("anti_squat_rear", "Anti-squat rear [0–1]", "Suspension", "num", "L3"),
